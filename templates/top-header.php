<?php
    $header_left_text = as_opt( 'smatika_top_bar_left_text' );
    $header_right_text = as_opt( 'smatika_top_bar_right_text' );
        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="right-part pull-right hidden-xs">
                    ...
                    <?php endif ?>
                    <?php if ( as_opt( 'smatika_show_top_social_icons' ) ): ?>
                        <div class="top-html-block">
                            <div class="social-links">
                                <?php foreach ( $social_links as $key => $value ): ?>
                                    <?php
                                    if ( !empty( $value ) ) {
                                        echo smatika_get_social_link( $value, true );
                                    }
                                    ?>
                                <?php endforeach ?>
                            </div>
